...
OnLoop(function(myHero)
           ...
           if  IOW:Mode() == "Combo" then
                     local target = GetCurrentTarget()
                        ...
                        if CanUseSpell(myHero, _E) == READY and EPred.HitChance == 1 and  GoS:EnemiesAround(EPred.PredPos, 250) >= 2 and GoS:ValidTarget(target, 925) and SorakaMenu.Combo.E:Value() then
