...
                       
                        local RPred = GetPredictionForPlayer(GetMyHeroPos(),target,GetMoveSpeed(target),500,0,GetCastRange(myHero,_R),250,false,false)
...
local EPred = GetPredictionForPlayer(GetMyHeroPos(),target,GetMoveSpeed(target),1550,300,1000,60,true,true)
...
                        CastSkillShot(_E,EPred.PredPos.x,EPred.PredPos.y,EPred.PredPos.z)
					...
					local QPred = GetPredictionForPlayer(2500,300,1000,100,true,true)
