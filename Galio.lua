        ...
        if IWalkConfig.Combo then
              local target = GetTarget(1200, DAMAGE_MAGIC)
                if ValidTarget(target, 1200) then
                        ...
                        local QPred = GetPredictionForPlayer(GetMyHeroPos(),target,GetMoveSpeed(target),1300,300,900,200,false,false)
						...
						local EPred = GetPredictionForPlayer(GetMyHeroPos(),target,GetMoveSpeed(target),1200,300,1200,120,false,false)
