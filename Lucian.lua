...
DrawingsConfig.addParam("DrawW","Draw W",
...
If CanUseSpell(myHero, _W) == READY and
DrawingsConfig.DrawW then
DrawSircle(myHeroPos.x,myHeroPos.y,myHeroPos.z,GetCastRange(myHero,_W),3,100.0xff00ff00) end
